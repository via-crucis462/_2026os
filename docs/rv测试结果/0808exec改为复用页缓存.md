2026/8/8 19:00 exec实现零拷贝（用cow方式实现）
OpenSBI v1.7
...
[timer] global SIE enabled
[timer] STIE enabled
[timer][ usegr] _lstart: oBSS andb haeap ilnitia lizedS (argc=I0)
E enabled
[timer][user ] _stSartT: aIE rgv parsed; entering emanaibln
[iend
it] runn[ing tcaigentm_etestcodre.]s h g...
lobal SIE enabled
...
ttetesstctecsaatscaes sceea c gceangte nktern ecl ppu apsassa gs3e 3nt8 f913

a

ctorial pass 403
testcase cagent date pass 383
testcase cagent fs-readwrite pass 433
Request: POST /v1/chat/completions HTTP/1.1
...
testcase cagent network pass 502
Request: POST /v1/chat/completions HTTP/1.1

Request: POST /v1/chat/completions HTTP/1.1

testcase cagent fs-create pass 694
Request: POST /v1/chat/completions HTTP/1.1

Request: POST /v1/chat/completions HTTP/1.1

testcase cagent fs-search pass 662
testcase cagent fs-usage pass 520
testcase cagent fs-directory pass 815
...
[1m[92m    Finished[0m `dev` profile [unoptimized + debuginfo] target(s) in 6.43s
...
[2026-08-08T10:28:08Z INFO  axbuild::context] Workspace root: /work/tgoskits
Using build config: /work/tgoskits/tmp/axbuild/config/arceos-helloworld/build-riscv64gc-unknown-none-elf.toml
[2026-08-08T10:28:09Z INFO  axbuild::build::config_file] Found build config at /work/tgoskits/tmp/axbuild/config/arceos-helloworld/build-riscv64gc-unknown-none-elf.toml
Using build config: /work/tgoskits/tmp/axbuild/config/arceos-helloworld/build-riscv64gc-unknown-none-elf.toml
[2026-08-08T10:28:11Z INFO  axbuild::build::config_file] Found build config at /work/tgoskits/tmp/axbuild/config/arceos-helloworld/build-riscv64gc-unknown-none-elf.toml
...
warning: `someboot` (lib) generated 1 warning
   ...
   Compiling arceos-helloworld v0.1.0 (/work/tgoskits/apps/arceos/helloworld)
    Finished `release` profile [optimized] target(s) in 21m 43s
...
[axbuild] cargo build package=arceos-helloworld target=scripts/targets/std/pie/riscv64gc-unknown-linux-musl.json config=/work/tgoskits/tmp/axbuild/config/arceos-helloworld/build-riscv64gc-unknown-none-elf.toml ... done (1317.79s)
