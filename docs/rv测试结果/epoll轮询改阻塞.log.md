...
[sbi-debug] start_hart(4) addr=0x80200000 ret=0x0
[timer] STIE enabled
...
[kernel] Hello from hart 4!
[kernel] Hello from hart 7!
[timer] STIE enabled
[timer] STIE enabled
[timer][user] _st art: gBSS anld heap initiaobliazled (argc=0)
 SIE e[usnabled
er] _sta[rt: argkv paersed; ernteringne mail]n
 H[init] ruenningl cagenlt_teostc odfroe.shm ... 
hart 3!
[timer] STIE enabled
[timer] global SIE enabled
[timer] global SIE enabled
...
Request: POST /v1/chat/completions HTTP/1.1
Request: POST /v1/chat/completions HTTP/1.1
testcase cagent factorial pass 264
Request: POST /v1/chat/completions HTTP/1.1
testcase cagent kernel pass 333
testcase cagent cpu pass 330
Request: POST /v1/chat/completions HTTP/1.1
Request: POST /v1/chat/completions HTTP/1.1
testcase cagent fs-readwrite pass 368
testcase cagent date pass 374
Request: POST /v1/chat/completions HTTP/1.1
testcase cagent network pass 446
Request: POST /v1/chat/completions HTTP/1.1
Request: POST /v1/chat/completions HTTP/1.1
testcase cagent fs-create pass 558
testcase cagent fs-usage pass 572
testcase cagent fs-search pass 608
Request: POST /v1/chat/completions HTTP/1.1
testcase cagent fs-directory pass 536
...
[UNIMPLEMENTED SYSCALL] ID: 430 pid=22 tid=22 comm=mount args=[0x40853c40,0x1,0x40853c40,0xafafafafcfc3dfdf,0x2000000000000,0x2]
[UNIMPLEMENTED SYSCALL] ID: 430 pid=22 tid=22 comm=mount args=[0x40853c40,0x1,0x40853c40,0xafafafdfcbdfd5df,0x2000000000000,0x2]
[UNIMPLEMENTED SYSCALL] ID: 430 pid=22 tid=22 comm=mount args=[0x40853c40,0x1,0x40853c40,0x303030303030303,0x2000000000000,0x2]
...
[1m[33mwarning[0m: failed to save last-use data
...
[1m[92m    Finished[0m `dev` profile [unoptimized + debuginfo] target(s) in 6.76s
...
[2026-08-08T16:24:40Z INFO  axbuild::context] Workspace root: /work/tgoskits
Using build config: /work/tgoskits/tmp/axbuild/config/arceos-helloworld/build-riscv64gc-unknown-none-elf.toml
[2026-08-08T16:24:41Z INFO  axbuild::build::config_file] Found build config at /work/tgoskits/tmp/axbuild/config/arceos-helloworld/build-riscv64gc-unknown-none-elf.toml
Using build config: /work/tgoskits/tmp/axbuild/config/arceos-helloworld/build-riscv64gc-unknown-none-elf.toml
[2026-08-08T16:24:42Z INFO  axbuild::build::config_file] Found build config at /work/tgoskits/tmp/axbuild/config/arceos-helloworld/build-riscv64gc-unknown-none-elf.toml
...
[axbuild] cargo build package=arceos-helloworld target=scripts/targets/std/pie/riscv64gc-unknown-linux-musl.json config=/work/tgoskits/tmp/axbuild/config/arceos-helloworld/build-riscv64gc-unknown-none-elf.toml ... done (1216.77s)
...
BUILDSTORM_COMPILE mode=multi ok=true elapsed_s=1224.94 cores=8 bytes=1681000 arch=riscv64
