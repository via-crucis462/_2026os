...
1. 项目结构
    ```text
        ...
        ├── README.md
        ├── rust-toolchain.toml
        ├── bl-new-qemu/                     -- RISC-V 64 启动固件
        │   └── rustsbi-qemu.bin
        ├── bootloader/                      -- LoongArch 64 启动固件
        │   └── rustsbi-qemu.bin
        ├── docs/                            -- 项目文档
        │   └── 初赛文档.md, *.png
        ├── os/                              -- 内核主目录
        ...
        │   ├── Makefile, build.rs
        │   ├── vendor/                      -- 依赖项(RustSBI/virtio-drivers等)
        │   └── src/
        │       ├── main.rs
    ...
    ```
    本项目的内核源码位于[os/src](../os/src/)，按照不同的功能分文件夹，详见仓库中的目录结构。
...
我们的文件系统整体结构如下：
![alt text](95592fad-4096-4441-8cd7-d89278d23eb5.png)
